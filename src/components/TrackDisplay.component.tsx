...
const TrackDisplay = ({
    ...
    const handleSecondaryLap = () => {
        ...
        if (neededState) {
            d3.selectAll("path").classed("secondary", true);
        } else {
            d3.selectAll("path").classed("secondary", false);
        }
    ...
    return (
        ...
        >
            <input
                id="tempSecondLapCheck"
                type="checkbox"
                checked={isSecondaryLap}
                onChange={handleSecondaryLap}
            ></input>
